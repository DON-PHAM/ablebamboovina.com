                ...
                <div id="map">
                    <div class="mapouter">
                        <div class="gmap_canvas">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29793.988211049866!2d105.8369637!3d21.022739599999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab9bd9861ca1%3A0xe7887f7b72ca17a9!2zSGFub2ksIEhvw6BuIEtp4bq_bSwgSGFub2k!5e0!3m2!1sen!2s!4v1689004204744!5m2!1sen!2s"
                        ...
                        <div class="contact-info-wrap">
                            <div class="single-contact-info">
                                ...
                                <div class="contact-info-dec">
                                    <p><a href="tel:{{ session('setting')->phone }}">{{ session('setting')->phone }}</a>
                                    </p>
                                </div>
                            </div>
                            <div class="single-contact-info">
                                ...
                                <div class="contact-info-dec">
                                    <p>
                                        <a href="mailto:{{ session('setting')->email }}">{{ session('setting')->email }}</a>
                                    </p>
                                </div>
                            </div>
                            <div class="single-contact-info">
                            ...
                            <div class="contact-social">
                                ...
                                <div class="social-info">
                                    <ul>
                                        <li>
                                            <a href="{{ session('setting')->facebook }}"><i
