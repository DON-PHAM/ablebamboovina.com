                    ...
                    <div class="product-details-img product-details-tab">
                        <div class="zoompro-wrap zoompro-2">
                            <div class="zoompro-border zoompro-span">
                                <img
                                    ...
                                    data-zoom-image="{{asset('upload/event/'.$product->code.'/'.$product->image)}}"
                                    alt=""
                                />
                            </div>
                        </div>
                        <div id="gallery" class="product-dec-slider-2 mt-3">
                            @foreach($product->images as $thumb)
                                <a
                                    class="active"
                                    data-image="{{asset('upload/event/'.$product->code.'/'.$thumb->image)}}"
                                    data-zoom-image="{{asset('upload/event/'.$product->code.'/'.$thumb->image)}}"
                                >
                                    <img
                                        style="max-width: 100px"
                                        src="{{asset('upload/event/'.$product->code.'/'.$thumb->image)}}"
                                        alt=""
                                    />
                                </a>
                            @endforeach
                        ...
                        <article class="list-product">
                            <div class="img-block">
                                <a href="{{route('detail-page',$pt->id)}}" class="thumbnail">
                                    <img
                                        class="first-img"
                                        src="{{asset('upload/event/'.$pt->code.'/'.$pt->image)}}"
                                        alt=""
                                    />
                                </a>
                            </div>
