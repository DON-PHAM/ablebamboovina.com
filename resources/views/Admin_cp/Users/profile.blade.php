            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">
                        <i class="fa fa-edit" aria-hidden="true"></i> {{trans('user.etting-user')}}
                    </h1>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"> {{trans('user.etting-user')}}</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form action="https://demo.s-cart.org/sc_admin/auth/setting" method="post"
...
<i class="fa fa-info-circle"></i> Để trống nếu không muốn thay đổi mật khẩu
                            ...
                            <div class="card-footer row">
                                <input type="hidden" name="_token" value="wD2EczIQh4UlDy32VbRenQeMO37srBKpEhqLCE9C">
                                <div class="col-md-2">
                                </div>
                                <div class="col-md-8">
