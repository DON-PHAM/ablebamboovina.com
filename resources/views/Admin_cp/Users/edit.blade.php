            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">
                        <i class="fa fa-plus" aria-hidden="true"></i> {{trans('user.edit')}}
                    </h1>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header with-border">
                            <h2 class="card-title">{{trans('user.edit')}}</h2>
                        ...
                        @if($user)
                            <form action="{{route('put-user-edit',$user->id)}}" method="post" accept-charset="UTF-8"
                                    ...
                                    <div class="form-group  row ">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="avatar-wrapper">
                                                <img class="profile-pic" src="{{asset('upload/avatar/'.$user->avatar)}}"/>
                                        ...
                                        <div class="col-sm-8">
                                            <section title=".slideThree">
                                                ...
                                                <div class="slideThree">
                                                    <input type="checkbox"  id="status" name="status" @if($user->status == 1) checked @endif/>
                                                </div>
                                                <!-- end .slideThree -->
                                            </section>
                                        </div>
