            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header with-border">
                            ...
                            <div class="card-tools">
                                <div class="btn-group float-right mr-5">
                                    <a target="_new" href="https://demo.s-cart.org/sc_admin/product"
                        ...
                        <form action="https://demo.s-cart.org/sc_admin/product/create" method="post" name="form_name"
                                ...
                                <div class="form-group row kind  ">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control shop_store select2 select2-hidden-accessible"
                                                ...
                                                name="shop_store[]" data-select2-id="3" tabindex="-1"
                                                aria-hidden="true">
                                            <option value=""></option>
