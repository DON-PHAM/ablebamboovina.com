...
@section('title',trans('event.title-create'))
@section('content')
    <style>
        input[type="file"] {
            display: block;
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">
                        <i class="fa fa-plus" aria-hidden="true"></i>{{trans('event.list-event')}}
                    </h1>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{trans('event.add')}}</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form action="{{route('post-event-create')}}" method="POST" name="form_name"
