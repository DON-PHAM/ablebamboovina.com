            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">
                        <i class="fa fa-plus" aria-hidden="true"></i> {{trans('event.add')}}
                    </h1>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header with-border">
                            <h2 class="card-title">{{trans('event.add')}}</h2>
                            <div class="card-tools">
                                <div class="btn-group float-right mr-5">
                                    <a href="{{route('event')}}" class="btn  btn-flat btn-default"
                                       title="List"><i class="fa fa-list"></i><span class="hidden-xs">{{trans('event.back')}}</span></a>
                                </div>
                            </div>
                        </div>


                        <form action="https://demo.s-cart.org/sc_admin/page/create" method="post" accept-charset="UTF-8"
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row  ">
                                                <label for="en__title" class="col-sm-2 col-form-label">Title <span
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="en__title" name="descriptions[en][title]"
                                                               value="" class="form-control en__title" placeholder="">
                                                    </div>
...
<i class="fa fa-info-circle"></i> Maximum 200 characters
                                            ...
                                            <div class="form-group row  ">
                                                <label for="en__keyword" class="col-sm-2 col-form-label">Keyword <span
                                                        class="seo" title="SEO"><i class="fa fa-coffee"
                                                                                   aria-hidden="true"></i></span></label>
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="en__keyword"
                                                               name="descriptions[en][keyword]" value=""
                                                               class="form-control en__keyword" placeholder="">
                                                    </div>
                                                    <span class="form-text">
<i class="fa fa-info-circle"></i> Maximum 200 characters
</span>
...
<i class="fa fa-info-circle"></i> Maximum 300 characters
                                            ...
                                            <div class="form-group row ">
                                                <label for="en__content" class="col-sm-2 col-form-label">Content</label>
                                                <div class="col-sm-8">
<textarea id="en__content" class="editor" name="descriptions[en][content]" style="visibility: hidden; display: none;">
                                                                ...
                                                                style="height: auto; user-select: none;"><span
                                                                    ...
                                                                    onmousedown="return false;"><span id="cke_21"
                                                                        ...
                                                                        role="toolbar"><span id="cke_36_label"
                                                                                             class="cke_voice_label">Chỉnh sửa</span><span
                                                                            class="cke_toolbar_start"></span><span
                                                                            class="cke_toolgroup" role="presentation"><a
                                                                                id="cke_37"
                                                                        ...
                                                                        role="toolbar"><span id="cke_41_label"
                                                                                             class="cke_voice_label">Bảng biểu</span><span
                                                                            class="cke_toolbar_start"></span><span
                                                                            class="cke_toolgroup" role="presentation"><a
                                                                                id="cke_42"
                                                                        ...
                                                                        id="cke_51" class="cke_toolbar"
                                                                        aria-labelledby="cke_51_label"
                                                                        role="toolbar"><span id="cke_51_label"
                                                                                             class="cke_voice_label">Kiểu cơ bản</span><span
                                                                            class="cke_toolbar_start"></span><span
                                                                            class="cke_toolgroup" role="presentation"><a
                                                                                id="cke_52"
                                                                        ...
                                                                        role="toolbar"><span id="cke_74_label"
                                                                        ...
                                                                        role="toolbar"><span id="cke_78_label"
                                                                        ...
                                                                        role="toolbar"><span id="cke_88_label"
                                                                        ...
                                                                        role="toolbar"><span id="cke_91_label"
                                                                        ...
                                                                        role="toolbar"><span id="cke_94_label"
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row  ">
                                                <label for="vi__title" class="col-sm-2 col-form-label">Title <span
                                                        class="seo" title="SEO"><i class="fa fa-coffee"
                                                                                   aria-hidden="true"></i></span></label>
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="vi__title" name="descriptions[vi][title]"
                                                               value="" class="form-control vi__title" placeholder="">
                                                    </div>
                                                    <span class="form-text">
<i class="fa fa-info-circle"></i> Maximum 200 characters
</span>
                                            ...
                                            <div class="form-group row  ">
                                                <label for="vi__keyword" class="col-sm-2 col-form-label">Keyword <span
                                                        class="seo" title="SEO"><i class="fa fa-coffee"
                                                                                   aria-hidden="true"></i></span></label>
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="vi__keyword"
                                                               name="descriptions[vi][keyword]" value=""
                                                               class="form-control vi__keyword" placeholder="">
                                                    </div>
                                                    <span class="form-text">
<i class="fa fa-info-circle"></i> Maximum 200 characters
</span>
                                            ...
                                            <div class="form-group row  ">
                                                <label for="vi__description" class="col-sm-2 col-form-label">Description
                                                    <span class="seo" title="SEO"><i class="fa fa-coffee"
                                                                                     aria-hidden="true"></i></span></label>
                                                <div class="col-sm-8">
...
<i class="fa fa-info-circle"></i> Maximum 300 characters
                                            ...
                                            <div class="form-group row ">
                                                <label for="vi__content" class="col-sm-2 col-form-label">Content</label>
                                                <div class="col-sm-8">
<textarea id="vi__content" class="editor" name="descriptions[vi][content]" style="visibility: hidden; display: none;">
                                                        ...
                                                        <div class="cke_inner cke_reset" role="presentation"><span
                                                                ...
                                                                style="height: auto; user-select: none;"><span
                                                                    ...
                                                                    onmousedown="return false;"><span id="cke_116"
                                                                        ...
                                                                        role="toolbar"><span id="cke_123_label"
                                                                                             class="cke_voice_label">Clipboard/Undo</span><span
                                                                            class="cke_toolbar_start"></span><span
                                                                            class="cke_toolgroup" role="presentation"><a
                                                                                id="cke_124"
                                                                        ...
                                                                        role="toolbar"><span id="cke_131_label"
                                                                                             class="cke_voice_label">Chỉnh sửa</span><span
                                                                            class="cke_toolbar_start"></span><span
                                                                            class="cke_toolgroup" role="presentation"><a
                                                                                id="cke_132"
                                                                        ...
                                                                        role="toolbar"><span id="cke_136_label"
                                                                            ...
                                                                            class="cke_toolbar_end"></span></span><span
                                                                        class="cke_toolbar_break"></span><span
                                                                        id="cke_146" class="cke_toolbar"
                                                                        aria-labelledby="cke_146_label"
                                                                        role="toolbar"><span id="cke_146_label"
                                                                                             class="cke_voice_label">Kiểu cơ bản</span><span
                                                                            class="cke_toolbar_start"></span><span
                                                                            class="cke_toolgroup" role="presentation"><a
                                                                                id="cke_147"
                                                                        ...
                                                                        role="toolbar"><span id="cke_155_label"
                                                                                             class="cke_voice_label">Đoạn</span><span
                                                                            class="cke_toolbar_start"></span><span
                                                                            class="cke_toolgroup" role="presentation"><a
                                                                                id="cke_156"
                                                                        ...
                                                                        role="toolbar"><span id="cke_169_label"
                                                                                             class="cke_voice_label">Liên kết</span><span
                                                                            class="cke_toolbar_start"></span><span
                                                                            class="cke_toolgroup" role="presentation"><a
                                                                                id="cke_170"
                                                                        ...
                                                                        role="toolbar"><span id="cke_173_label"
                                                                            ...
                                                                            class="cke_toolbar_end"></span></span><span
                                                                        class="cke_toolbar_break"></span><span
                                                                        id="cke_182" class="cke_toolbar"
                                                                        aria-labelledby="cke_182_label"
                                                                        role="toolbar"><span id="cke_182_label"
                                                                                             class="cke_voice_label">Kiểu</span><span
                                                                            class="cke_toolbar_start"></span><span
                                                                            id="cke_112"
                                                                            class="cke_combo cke_combo__styles cke_combo_off"
                                                                        ...
                                                                        role="toolbar"><span id="cke_183_label"
                                                                                             class="cke_voice_label">Màu sắc</span><span
                                                                            class="cke_toolbar_start"></span><span
                                                                            class="cke_toolgroup" role="presentation"><a
                                                                                id="cke_184"
                                                                        ...
                                                                        role="toolbar"><span id="cke_186_label"
                                                                                             class="cke_voice_label">Công cụ</span><span
                                                                            class="cke_toolbar_start"></span><span
                                                                            class="cke_toolgroup" role="presentation"><a
                                                                                id="cke_187"
                                                                        ...
                                                                        role="toolbar"><span id="cke_189_label"
                                                                                             class="cke_voice_label">about</span><span
                                                                            class="cke_toolbar_start"></span><span
                                                                            class="cke_toolgroup" role="presentation"><a
                                                                                id="cke_190"
                                                ...
                                                <div class="input-group-append">
                                                    <a data-input="image" data-preview="preview_image" data-type="page"
                                                       class="btn btn-primary lfm">
                                                        <i class="fa fa-image"></i> Chose image
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group row  ">
                                        <label for="alias" class="col-sm-2 col-form-label">Url customize <span
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control shop_store select2 select2-hidden-accessible"
                                                    multiple="" data-placeholder="Select store" style="width: 100%;"
                                                    name="shop_store[]" data-select2-id="1" tabindex="-1"
                                                    aria-hidden="true">
                                                <option value=""></option>
                                                        ...
                                                        tabindex="-1" aria-disabled="false"><ul
                                                            class="select2-selection__rendered"><li
                                                                class="select2-search select2-search--inline"><input
                                                                    ...
                                                                    style="width: 1035.66px;"></li></ul></span></span><span
                            ...
                            <div class="card-footer row">
                                <input type="hidden" name="_token" value="SCtqzoyTBQAwU28R9LdaiOHE65vNmYcxrt3CnyjT">
                                <div class="col-md-2">
                                </div>
                                <div class="col-md-8">
