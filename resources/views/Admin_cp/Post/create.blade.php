            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">
                        <i class="fa fa-plus" aria-hidden="true"></i> {{trans('post.add')}}
                    </h1>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header with-border">
                            <h2 class="card-title">{{trans('post.add')}}</h2>
                        ...
                        <form action="{{route('post-new-create')}}" method="post" accept-charset="UTF-8"
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="ko_name" name="ko_name"
                                                           value="{{old('ko_name')}}" class="form-control ko_name"
                                                           placeholder="">
                                                </div>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="ko_metakeyword" name="ko_metakeyword"
                                                           value="{{old('ko_metakeyword')}}" class="form-control ko_metakeyword" placeholder="">
                                                </div>
                                                <span class="form-text">
<i class="fa fa-info-circle"></i> Tối đa 200 kí tự
</span>
...
<i class="fa fa-info-circle"></i> Tối đa 300 kí tự
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-sm-8">
<textarea id="ko_content" class="editor" name="ko_content" style="visibility: hidden; display: none;">{{old('ko_content')}}
                                    </textarea>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="vi_metakeyword" name="vi_metakeyword"
                                                           value="{{old('vi_metakeyword')}}" class="form-control vi_metakeyword" placeholder="">
                                                </div>
                                                <span class="form-text">
<i class="fa fa-info-circle"></i> Tối đa 200 kí tự
</span>
...
<i class="fa fa-info-circle"></i> Tối đa 300 kí tự
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-sm-8">
<textarea id="vi_content" class="editor" name="vi_content" style="visibility: hidden; display: none;">{{old('vi_content')}}
                                    </textarea>
