                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="en__keyword" name="descriptions[en][keyword]"
                                                           value="" class="form-control en__keyword" placeholder="">
                                                </div>
                                                <span class="form-text">
<i class="fa fa-info-circle"></i> Tối đa 200 kí tự
</span>
...
<i class="fa fa-info-circle"></i> Tối đa 300 kí tự
                                        ...
                                        <div class="form-group row ">
                                            <label for="en__content" class="col-sm-2 col-form-label">Nội dung</label>
                                            <div class="col-sm-8">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="vi__keyword" name="descriptions[vi][keyword]"
                                                           value="" class="form-control vi__keyword" placeholder="">
                                                </div>
                                                <span class="form-text">
<i class="fa fa-info-circle"></i> Tối đa 200 kí tự
</span>
...
<i class="fa fa-info-circle"></i> Tối đa 300 kí tự
                                        ...
                                        <div class="form-group row ">
                                            <label for="vi__content" class="col-sm-2 col-form-label">Nội dung</label>
                                            <div class="col-sm-8">
<textarea id="vi__content" class="editor" name="descriptions[vi][content]" style="visibility: hidden; display: none;">
                                ...
                                <div class="form-group  row ">
                                    <label for="sort" class="col-sm-2 col-form-label">Sắp xếp</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                ...
                                <div class="form-group row ">
                                    <label for="shop_store" class="col-sm-2 col-form-label">Chọn cửa hàng</label>
                                    <div class="col-sm-8">
                                        <select class="form-control shop_store select2 select2-hidden-accessible"
                                                multiple="" data-placeholder="Chọn cửa hàng" style="width: 100%;"
                                ...
                                <div class="form-group  row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false"
                                             style="position: relative;"><input class="checkbox" type="checkbox"
                                                                                name="status"
