            ...
            <div class="row d-flex align-items-center">
                <div class="col-md-6">
                    <div class="page-breadcrumb">
                        ...
                        <a href="{{route('get-category-new-create')}}" class="btn btn-danger">{{trans('home.add')}}</a>
                    </div>
                            ...
                            @if($categories)
                                @foreach($categories as $item  )
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('get-category-new-edit', ['id' => $item->postcategoryid])}}"><i
                                                    class="fa fa-edit"></i></a>
                                            <a href="{{route('delete-category-new-edit', ['id' => $item->postcategoryid])}}"><i
