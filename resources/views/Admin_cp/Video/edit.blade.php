            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">
                        <i class="fa fa-plus" aria-hidden="true"></i> {{trans('video.edit')}}
                    </h1>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{trans('video.edit')}}</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="btn-group float-right mr-5">
                                    <a href="{{route('video')}}" class="btn  btn-flat btn-default"
                                       title="List"><i class="fa fa-list"></i><span
                                            class="hidden-xs"> {{trans('video.back')}}</span></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <form action="{{route('post-video-edit',$video->id)}}" method="post" accept-charset="UTF-8"
                                ...
                                <div class="card-body">
                                    <div class="form-group  row ">
                                        <label for="name"
                                               class="col-sm-2  control-label">{{trans('video.name')}}</label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="name" name="name" value="{{$video->name}}"
                                ...
                                <div class="card-footer row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="btn-group float-right">
                                            <button type="submit"
                                                    class="btn btn-primary">{{trans('video.save')}}</button>
                                        </div>
                                        <div class="btn-group float-left">
                                            <button type="reset"
                                                    class="btn btn-warning">{{trans('video.reset')}}</button>
                                        </div>
                                    </div>
                                </div>
