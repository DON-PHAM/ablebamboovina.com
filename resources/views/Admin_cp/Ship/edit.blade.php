            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">
                        <i class="fa fa-plus" aria-hidden="true"></i> {{trans('ship.edit')}}
                    </h1>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{trans('ship.edit')}}</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header with-border">
                            <h2 class="card-title">{{trans('ship.edit')}}</h2>
                        ...
                        @if($ship)
                            <form action="{{route('post-ship-edit',$ship->id)}}" method="post" accept-charset="UTF-8"
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="ko_name" name="ko_name"
                                                                   value="{{$ship_ko->name}}"
                                                                   class="form-control ko_name" placeholder="">
                                                        </div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="vi_name" name="vi_name"
                                                                   value="{{$ship_vi->name}}"
                                                                   class="form-control vi_name" placeholder="">
                                                        </div>
                                                        <span class="form-text">
<i class="fa fa-info-circle"></i> Tối đa 200 kí tự
</span>
                                        ...
                                        <div class="form-group row  ">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="code" name="code" value="{{$ship->code}}"
                                        ...
                                        <div class="form-group row  ">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input type="text" id="price" name="price" value="{{$ship->price}}"
                                        ...
                                        <div class="form-group row  ">
                                            <label for="alias"
                                                   class="col-sm-2 col-form-label">{{trans('ship.price-free')}}
                                                <span
                                                    class="seo" title="SEO"><i class="fa fa-coffee"
                                                                               aria-hidden="true"></i></span></label>
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="price_free" name="price_free"
                                                           value="{{$ship->price_free}}"
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="checkbox" @if($ship->status == 1) checked @endif type="checkbox" name="status">
                                ...
                                <div class="card-footer row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="btn-group float-right">
                                            <button type="submit"
                                                    class="btn btn-primary">{{trans('home.save')}}</button>
                                        </div>
                                        <div class="btn-group float-left">
                                            <button type="reset"
                                                    class="btn btn-warning">{{trans('home.reset')}}</button>
                                        </div>
                                    </div>
                                </div>
