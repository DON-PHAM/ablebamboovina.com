            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">
                        <i class="fa fa-plus" aria-hidden="true"></i> Tạo mới thông tin
                    </h1>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form action="{{route('post-about-create')}}" method="post" accept-charset="UTF-8"
...
<i class="fa fa-info-circle"></i> Tối đa 300 kí tự
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-sm-8">
<textarea id="ko_contents" class="editor" name="ko_contents" > {{old('ko_contents')}}
                                    </textarea>
...
<i class="fa fa-info-circle"></i> Tối đa 300 kí tự
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-sm-8">
<textarea id="vi_contents" class="editor" name="vi_contents" style="visibility: hidden; display: none;">{{old('vi_contents')}}
                                    </textarea>
