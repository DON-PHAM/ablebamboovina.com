                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header with-border">
                            <h2 class="card-title">Sửa</h2>
                            <div class="card-tools">
                                <div class="btn-group float-right mr-5">
                                    <a href="{{route('about')}}" class="btn  btn-flat btn-default"
                        ...
                        @if($about)
                            ...
                            <form action="{{route('post-about-edit',$about->id)}}" method="post" accept-charset="UTF-8"
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="ko_name" name="ko_name"
                                                               value="{{$about_ko->title}}" class="form-control ko_name"
                                                               placeholder="">
                                                    </div>
...
<i class="fa fa-info-circle"></i> Tối đa 200 kí tự
                                            ...
                                            <div class="form-group  row ">
                                                ...
                                                <textarea id="ko_description" name="ko_description"
                                                          ...
                                                          placeholder="">{{$about_ko->description}}</textarea>
                                                    <span class="form-text">
<i class="fa fa-info-circle"></i> Tối đa 300 kí tự
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-sm-8">
<textarea id="ko_contents" class="editor" name="ko_contents"> {{$about_ko->contents}}
                                    </textarea>
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="vi_name" name="vi_name"
                                                               value="{{$about_vi->title}}" class="form-control vi_name"
                                                               placeholder="">
                                                    </div>
                                                    <span class="form-text">
<i class="fa fa-info-circle"></i> Tối đa 200 kí tự
                                            ...
                                            <div class="form-group  row ">
                                                ...
                                                <textarea id="vi_description" name="vi_description"
                                                          ...
                                                          placeholder="">{{$about_vi->description}}</textarea>
                                                    <span class="form-text">
<i class="fa fa-info-circle"></i> Tối đa 300 kí tự
</span>
                                                </div>
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-sm-8">
<textarea id="vi_contents" class="editor" name="vi_contents" style="visibility: hidden; display: none;">{{$about_vi->contents}}
                                    </textarea>
                                    ...
                                    <div class="form-group  row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="status" type="checkbox" @if($about->status == 1) checked @endif name="status">
                                        </div>
                                    </div>
                                </div>
